  ...
  return (
    <DashboardLayout>
      ...
      {loading ? (
        ...
        <div className="card p-6 bg-white dark:bg-slate-800/50">
          <div className="grid grid-cols-7 gap-2 mb-4 text-center text-sm font-semibold text-slate-500 dark:text-slate-400">
            <div>Sun</div>
            <div>Mon</div>
            <div>Tue</div>
            <div>Wed</div>
            ...
            {days.map((day, idx) => {
              ...
              return (
                ...
                >
                  {day && (
                    <>
                      <div className={`text-sm font-bold mb-2 ${isToday ? 'text-brand-400' : 'text-slate-700 dark:text-white'}`}>
                        {day}
                      </div>
